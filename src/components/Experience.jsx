...
const TIMELINE = [
  {
    ...
    org: 'Fulltime / Spacetoon-GamePower7',
    period: '2024 – Present',
    branch: 'main',
    ...
    details: [
      ...
      'Performed game polishing and visual bug fixing to enhance overall visual quality',
      'Enhanced player experience through meticulous attention to visual details and performance optimization.',
      'Implemented smooth in-game animations (character movement, cutscenes, or interactive objects)',
      'Designed and built game environments and terrain (landscape sculpting, texture painting, and prop placement)',
    ],
  ...
  },
  {
    hash: 'b1e8f77',
    type: 'education',
    title: 'B.Sc. Information Engineering- Cybersecurity',
    org: 'Syrian Virtual University (SVU)',
    period: '2019 – 2026',
    branch: 'feature/security',
    branchColor: 'var(--neon)',
    details: [
      'Graduation project: SVU Vulnerability Scanner — graded Distinction (87/100)',
      'Specialized in Software Engineering and Security',
      'Completed 11+ cybersecurity certifications (IBM, Google, Cisco)',
      'Completed OverTheWire: Bandit challenges',
    ...
    tags: ['Python', 'Network Security', 'Web Security', 'Penetration Testing'],
  },
];
